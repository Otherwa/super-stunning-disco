...
function sendEmailHacker(email, otp, price) {
  ...
  var mailOptions = {
    ...
    to: email,
    subject: 'Thanks For Registering to Hacker Within US',
                                    ...
                                    <td class="pad" style="padding-left:20px;padding-top:20px;">
                                      <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                        <div class style="font-size: 14px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 16.8px; color: #63c9cb; line-height: 1.2;">
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">Thank You&nbsp;</span></p>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
                                ...
                                <table class="text_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                  <tr>
                                    <td class="pad" style="padding-left:20px;">
                                      <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                        <div class style="font-size: 14px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 16.8px; color: #63c9cb; line-height: 1.2;">
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">For Booking&nbsp;</span></p>
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">Hacker Within Us</span></p>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
...
// send signup email
function sendEmailTreasure(email, otp, price) {

  var mailOptions = {
    from: process.env.EMAIL,
    to: email,
    subject: 'Thanks For Registering to Treasure Hunt',
    text: 'Thanks For Registering',
    html:
      `
      <!DOCTYPE html>
                                  ...
                                  <tr>
                                    <td class="pad" style="padding-left:20px;">
                                      <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                        <div class style="font-size: 14px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 16.8px; color: #63c9cb; line-height: 1.2;">
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">For Booking&nbsp;</span></p>
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">Treasure Hunt</span></p>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
...
// send signup email
function sendEmailMania(email, otp, price) {

  var mailOptions = {
    from: process.env.EMAIL,
    to: email,
    subject: 'Thanks For Registering to Inventrix Mania',
    text: 'Thanks For Registering',
    html:
      `
      <!DOCTYPE html>
                                  ...
                                  <tr>
                                    <td class="pad" style="padding-left:20px;">
                                      <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                        <div class style="font-size: 14px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 16.8px; color: #63c9cb; line-height: 1.2;">
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">For Booking&nbsp;</span></p>
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">Inventrix Mania</span></p>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
...
// send signup email
function sendEmailSys(email, otp, price) {

  var mailOptions = {
    from: process.env.EMAIL,
    to: email,
    subject: 'Thanks For Registering to Save The System',
    text: 'Thanks For Registering',
    html:
      `
      <!DOCTYPE html>
                                  ...
                                  <tr>
                                    <td class="pad" style="padding-left:20px;">
                                      <div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
                                        <div class style="font-size: 14px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 16.8px; color: #63c9cb; line-height: 1.2;">
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">For Booking&nbsp;</span></p>
                                          <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;">Save The System</span></p>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
